...
# @update: Aug. 10th, 2014
# @author: hitigon@gmail.com
from __future__ import print_function
import re
import json
from mongoengine.errors import DoesNotExist
from libs.utils import create_id, create_secret
from . import BaseHandler, CreateSuccess
...
def process_uris(uris):
    result = []
    for sub in re.split(';|,| |\n', uris):
        if len(sub) > 0:
            result.append(sub.strip())
    return result, result and result[0] or ''
